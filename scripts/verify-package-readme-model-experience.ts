...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-home': { kind: 'none', reason: 'Browser-side pure React HOME empty-state atoms; registers nothing model-facing.' },
  'packages/client/ui-task-side-rail': { kind: 'none', reason: 'Browser-side pure React task side-rail atoms; registers nothing model-facing.' },
