...
/**
 * No runtime invariant: this package is a static-catalog presentation shell.
 * It emits no cordis events, owns no cross-plugin mutable state, and ships no
 * Host mutation path in the scaffold cut.
 */
