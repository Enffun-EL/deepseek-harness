...
/**
 * No runtime invariant: a single shell.overlay registration whose open/query
 * state is React-local. The plugin emits no cordis events and owns no
 * cross-plugin mutable state; filter purity is asserted by package specs.
 */
